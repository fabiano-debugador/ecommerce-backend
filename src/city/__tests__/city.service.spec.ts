...
describe('CityService', () => {
  ...
  it('should return error findOne not find', async () => {
  ...
  it('should return cities in getAllCitiesByStatId', async () => {
    const city = await service.getAllCitiesByStatId(cityMock.id);
